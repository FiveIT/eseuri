  ...
  {#if show}
    <div
      ...
      <div
        ...
        <div
          class="col-span-4 row-start-2 row-end-5 "
          bind:this={messageParent}>
          <span class="text-sm" bind:this={messageChild}>
            Prin ștergerea contului îți pierzi toate marcajele și asocierile cu
            elevii/profesorii tăi. De altfel, îți pierzi și statutul de profesor
            pe platformă, dacă e cazul, iar în situația în care îți creezi un
            cont nou va trebui să redepui o cerere pentru a fi profesor.
            Lucrările tale nu vor fi șterse: acestea vor rămâne permanent pe
            platformă. Dacă totuși dorești să fie șterse <a
              href="mailto:info@example.com"
              class="underline">contactează-ne pe email.</a>
          </span>
        </div>
        <button
          ...
          <span
            ...
            bind:this={button1Child}>Anulez ștergerea</span>
        </button>
        <button
          ...
          <span
            class="text-sm self-center w-full h-min "
            bind:this={button2Child}>Înțeleg, îmi șterg contul</span>
        </button>
      </div>
    </div>
  {/if}
