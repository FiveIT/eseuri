...
{#if alive}
  <div
    class="w-full pb-lg  h-full flex flex-row justify-center flex-wrap relative scrollbar-window-padding  ">
    <div
      ...
      <div
        ...
        {#if eseuri_chosen == true}
          <div
            class="mb-lg grid-cols-essays auto-rows-essays max-w-layout grid relative fixed grid row-start-5  col-start-1 col-end-7 overflow-x-visible w-full h-full gap-x-lg gap-y-sm "
